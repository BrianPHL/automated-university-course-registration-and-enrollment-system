                    ...
                    <div id="dashboardSection">
                        ...
                        <div class="admin-accounts" style="display: none;">
                            ...
                            <div class="header">
                                ...
                                <p><a class="breadcrumb-link" data-page="home">Dashboard</a><span style="margin-right: 0.5rem; ">/</span>Accounts (Admin)</p>

                            </div>

                            <div class="table">

                                <table id="admin-accounts-table" class="cell-border nowrap order-column">
                                    ...
                                    <tbody>
                                        ...
                                        $results = getAccountsData($conn, 'admin');
