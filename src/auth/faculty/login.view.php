    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="info">
                ...
                <h4>Welcome back!</h4>
                <h5>Sign in to your faculty account.</h5>
            ...
            <form method="POST" action="https://localhost/aucres/api/login.php">
                ...
                <div class="wrapper">
                    ...
                    <div class="cta">
                        ...
                        <button type="button" class="portalSwitcher" onclick="event.preventDefault(); location.href='https://localhost/aucres/public/login.php?action=switch'">
